...
class SlicesThumbs(db.Model):
    ...
    def getPathToDir(self):
        return os.path.join(self.reco.getPathToDir(), "slices_thumbs")

    def getPathToThumbs(self):
        return os.path.join(self.getPathToDir(), 'map-%05i.jpg')
...
class SliceMap(db.Model):
    ...
    def getPathToDir(self):
        return os.path.join(self.reco.getPathToDir(), "slice_map")
...
class Reconstruction(db.Model):
    ...
    def getPathToSlices(self):
        return os.path.join(self.getPathToDir(), 'slice*.tif')
